package com.boot.leetcode.threeequalparts;

import java.util.Arrays;

/**
 * @PackageName: com.boot.leetcode.threeequalparts
 * @ClassName: ThreeEqualParts
 * @Description: This is ThreeEqualParts class by Skwen.
 * @Author: Skwen
 * @Date: 2021-05-28 3:06
 */
public class ThreeEqualParts {
    public static void main(String[] args) {
        System.out.println(threeEqualParts(new int[]{1, 0, 1, 0, 1}));
    }
